...
import com.sadtech.collections.domain.DomainRepository;
...
public class Application {
    ...
    /*@Bean
    CommandLineRunner init(DomainRepository domainRepository,GreetingRepository greetingRepository) {

        return args -> {

            Domain domain1 = domainRepository.findOne(7L);
            System.out.println(domain1);

            Domain domain2 = domainRepository.findFirstByDomain("sadtech.com");
            System.out.println(domain2);

            //obj2.setDisplayAds(true);
            //domainRepository.save(obj2);

            //int n = domainRepository.updateDomain("sadtech.com", true);
            ...
            Greeting greeting = greetingRepository.findById(1);
